...
| Portainer in docker container opstarteb| `docker-compose -f docker-compose.portainer.yml up -d`|
| Image aanmaken | `docker build -t (naam)` |
| docker container stoppen | `docker stop id-container`|
